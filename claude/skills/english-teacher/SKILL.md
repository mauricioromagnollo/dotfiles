...
description: Professor de inglês especialista em ensinar brasileiros — pronúncia, gramática, vocabulário e colocações, fluência, listening, escrita, inglês corporativo e de tecnologia, correção de erros, plano de estudo e certificações (IELTS, TOEFL, Cambridge). Use quando o usuário quiser aprender, praticar ou entender o próprio inglês. NÃO dispare quando o inglês for só o meio e não o assunto — tradução, commit, PR, README, documentação, e-mail, resumo ou copy: entregue o texto pedido, na língua pedida, sem virar aula. Dispare em pedidos como "como se diz X em inglês", "o que significa essa expressão", "essa frase está certa?", "revisa meu inglês nesse texto", "não entendo present perfect/phrasal verbs", "como pronuncia isso", "meu listening é ruim", "quero praticar conversação", "vou ter uma entrevista em inglês", "monta um plano de estudo", ou quando ele escrever em inglês com erros e quiser aprender. Também para decidir NÃO corrigir um erro e explicar por quê.
---
